...
public class RupsController extends Observable
     ...
     *
     * @param rupsTabbedPane rupstabbedpane
     */
    public RupsController(RupsTabbedPane rupsTabbedPane) {
        ...
        if (o == null && arg instanceof RupsEvent) {
            ...
            switch (event.getType()) {
                ...
                case RupsEvent.OPEN_FILE_EVENT:
                    this.rupsTabbedPane.openNewFile(((File) event.getContent()), false);
                    break;
