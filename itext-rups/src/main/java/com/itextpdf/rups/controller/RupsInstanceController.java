 ...
 * <p>
 * A RupsInstanceController instance will be owned by a {@link RupsTabbedPane RupsTabbedPane}
 * instance. Which in turn is controlled by a {@link RupsController RupsController}
 * instance.
 */
        ...
        if (o != null && arg instanceof RupsEvent) {
            ...
            if (RupsEvent.CONSOLE_WRITE_EVENT == event.getType()) {
                if ( readerController != null ) {
                    JTabbedPane editorTabs = readerController.getEditorTabs();
                    if ( editorTabs != null ) {
