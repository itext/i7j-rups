...
public class OpenInViewerAction implements ActionListener {
    ...
    private final IPdfController controller;
     ...
     */
    public OpenInViewerAction(IPdfController controller, ISystemViewerAction systemViewerAction) {
    ...
    public final void actionPerformed(ActionEvent e) {
        ...
        final IPdfFile pdfFile = this.controller.getPdfFile();
