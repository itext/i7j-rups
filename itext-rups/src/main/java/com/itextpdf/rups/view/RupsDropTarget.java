...
public class RupsDropTarget extends DropTarget {
     ...
     */
    private final IPdfController pdfController;

    /**
     * Creates a RupsDropTarget
     *
     * @param pdfController the controller instance that controls the application
     */
    public RupsDropTarget(IPdfController pdfController) {
        ...
        if (dtde != null) {
            ...
            for (final File file : files) {
                if (PdfFilter.INSTANCE.accept(file)) {
                    this.pdfController.openNewFile(file);
                }
            }
