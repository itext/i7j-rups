...
import com.itextpdf.rups.api.IRupsController;
...
public class MockedRupsController implements IRupsController, IPdfController {
    ...
    @Override
    public Collection<IPdfFile> getAllOpenPdfFiles() {
        return null;
    }
